...
/* The d3-horizontalBarChartDiagrammCode */
		...
		var data = {
		    labels: ['Niendorf', 'Wandsbek', 'Lokstedt'],   // Hier müssen dann die StadtteilNamen aus der Datenbank stehen,
					series: 								// welche per selectBox ausgewählt wurden
					[
						{
						  label: 'CDU',				// Die 3 Label sollen dann die Parameter der selectAuswahl sein.
						  values: [4, 8, 15]		// die values aus der mySQL Datenbank einlesen.
						},
						{
						  label: 'FPD',
						  values: [12, 43, 22]
